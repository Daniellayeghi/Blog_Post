...
int main()
{
    ...
    using namespace std;
    cout << "ds/dx real     = " << cos(0.12) << endl;         // print the evaluated output u
    cout << "ds/dx finite   = " <<  dsdx_finite << endl;  // print the evaluated derivative du/dx
    cout << "ds/dx autodiff forward  =  " << dsdx_autodiff_for << endl;  // print the evaluated derivative du/dy
    cout << "ds/dx autodiff reverse  =  " << dsdx_autodiff_rev << endl;  // print the evaluated derivative du/dy
